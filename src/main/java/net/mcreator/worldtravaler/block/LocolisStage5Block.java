...
public class LocolisStage5Block extends WorldTravalerModElements.ModElement {
	@ObjectHolder("world_travaler:locolis_stage_5")
	public static final Block block = null;

	public LocolisStage5Block(WorldTravalerModElements instance) {
		super(instance, 63);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("locolis_stage_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("world_travaler:locolis_stage_5"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("locolis_stage_5");
		}
