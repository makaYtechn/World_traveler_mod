...
package net.mcreator.worldtravaler.block;
...
public class LocolisStage4Block extends WorldTravalerModElements.ModElement {
	@ObjectHolder("world_travaler:locolis_stage_4")
	public static final Block block = null;

	public LocolisStage4Block(WorldTravalerModElements instance) {
		super(instance, 62);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("locolis_stage_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("world_travaler:locolis_stage_4"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("locolis_stage_4");
		}
