...
public class LocolisStage3Block extends WorldTravalerModElements.ModElement {
	@ObjectHolder("world_travaler:locolis_stage_3")
	public static final Block block = null;

	public LocolisStage3Block(WorldTravalerModElements instance) {
		super(instance, 61);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("locolis_stage_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("world_travaler:locolis_stage_3"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("locolis_stage_3");
		}
