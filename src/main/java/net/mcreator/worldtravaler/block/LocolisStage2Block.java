...
public class LocolisStage2Block extends WorldTravalerModElements.ModElement {
	@ObjectHolder("world_travaler:locolis_stage_2")
	public static final Block block = null;

	public LocolisStage2Block(WorldTravalerModElements instance) {
		super(instance, 60);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("locolis_stage_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("world_travaler:locolis_stage_2"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("locolis_stage_2");
		}
