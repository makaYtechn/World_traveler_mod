...
import net.mcreator.worldtravaler.item.KristalSkintaItem;
...
public class DeleteKrystalSkintProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("dimension") == null) {
			if (!dependencies.containsKey("dimension"))
				WorldTravalerMod.LOGGER.warn("Failed to load dependency dimension for procedure DeleteKrystalSkint!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WorldTravalerMod.LOGGER.warn("Failed to load dependency entity for procedure DeleteKrystalSkint!");
			return;
		}
		...
		if ((entity.getCapability(WorldTravalerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (((entity instanceof PlayerEntity)
					? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(KristalSkintaItem.block))
					: false) == true) {
				if ((dimension) == (World.OVERWORLD)) {
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(KristalSkintaItem.block);
