...
import net.mcreator.worldtravaler.item.OskolokItem;
...
public class DeleteOskolokProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("dimension") == null) {
			if (!dependencies.containsKey("dimension"))
				WorldTravalerMod.LOGGER.warn("Failed to load dependency dimension for procedure DeleteOskolok!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WorldTravalerMod.LOGGER.warn("Failed to load dependency entity for procedure DeleteOskolok!");
			return;
		}
		...
		if ((entity.getCapability(WorldTravalerModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (((entity instanceof PlayerEntity)
					? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(OskolokItem.block))
					: false) == true) {
				if ((dimension) == (World.OVERWORLD)) {
					if (entity instanceof PlayerEntity) {
						ItemStack _stktoremove = new ItemStack(OskolokItem.block);
